...
public class MovieListDaoCollectionImpl implements MovieListDao {
	...
	public MovieListDaoCollectionImpl() 
	{
		if(movieList==null)
		{
			...
			movieList.add(new MovieList(0000001,"Avatar",2787965087f,true, DateUtil.convertToDate("28/09/1997"), "Science Fiction",true));
			movieList.add(new MovieList(0000002,"The Avengers",1518812988f,true, DateUtil.convertToDate("18/04/1996"), "Superhero",false));
			movieList.add(new MovieList(0000003,"Titanic",1187463944f,true, DateUtil.convertToDate("23/07/1996"), "Romance",false));
			movieList.add(new MovieList(0000004,"Jurassic World",1671713208f,true, DateUtil.convertToDate("08/01/1996"), "Science Fiction",true));
			movieList.add(new MovieList(0000005," End Game",2750760348f,true, DateUtil.convertToDate("02/04/1996"), "Superhero",true));
			}
